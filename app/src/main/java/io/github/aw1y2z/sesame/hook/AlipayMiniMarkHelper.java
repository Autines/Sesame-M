...
public class AlipayMiniMarkHelper {
    ...
    public static String getAlipayMiniMark(String str, String str2) {
        try {
            ...
            //Class<?> h5HttpUtilsClass = XHelpers.findClass("com.alibaba.ariver.nebula.util.H5HttpUtils", classLoader);
            Class<?> h5HttpUtilsClass = XHelpers.findClass("com.alibaba.mobile.nebula.util.H5HttpUtils", classLoader);
            Object resultObj = XHelpers.callStaticMethod(h5HttpUtilsClass, "getAlipayMiniMark", str, str2);
